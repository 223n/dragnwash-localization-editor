...
var lineReaderDiffs = map[string]knownDiff{
	...
	"ml-edit-working-crlf": {diffLineBased, whyLineSplit, []string{
		`L2 の終わり: 上流 3 / dwloc 2`,
		`L2 translation: 上流 "いち\n" / dwloc "いち"`,
		`L4 の終わり: 上流 5 / dwloc 4`,
		`L4 translation: 上流 "\nに" / dwloc ""`,
		`dwloc だけ L5 ["に\"" "" "" "" "" "" ""]`,
		`L6 の終わり: 上流 8 / dwloc 6`,
		`L6 translation: 上流 "「さ\"ん」、\n  よん, ご  \n\"ろく\"" / dwloc "「さ\"ん」、"`,
		`dwloc だけ L7 ["よん" "ご " "" "" "" "" ""]`,
		`dwloc だけ L8 ["ろく\"\"\"" "" "" "" "" "" ""]`,
		`L9 の終わり: 上流 12 / dwloc 9`,
		`L9 translation: 上流 "し\n# ご\n\nはち" / dwloc "し"`,
		`dwloc だけ L12 ["はち\"" "" "" "" "" "" ""]`,
	}},
	"ml-edit-published-lf": {diffLineBased, whyLineSplit, []string{
		`L2 の終わり: 上流 3 / dwloc 2`,
		`L2 translation: 上流 "いち\nに" / dwloc "いち"`,
		`dwloc だけ L3 ["に\"" "" "" "" "" ""]`,
		`L4 の終わり: 上流 7 / dwloc 4`,
		`L4 translation: 上流 "\n\nに,さん\n" / dwloc ""`,
		`dwloc だけ L6 ["に" "さん" "" "" "" ""]`,
	}},
